...
import { screens, totalScreens, dPathwayMap, debriefBaselines, phaseCards } from "./data.js?v=20260913a";
import { renderScreen, formatPercent, el } from "./render.js?v=20260913a";
import {
  trackInitialized,
  trackAnswered,
